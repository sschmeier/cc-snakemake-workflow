...
# sphinx-quickstart on Sun Nov 27 18:07:24 2016.
#
...
copyright = '{{cookiecutter.date}}, {{cookiecutter.author_name}}'
...
#
# html_title = '{{cookiecutter.package_name}}  v{{cookiecutter.version}}'
...
latex_documents = [
    (master_doc, 'documentation.tex', '{{cookiecutter.package_name}} Documentation',
...
man_pages = [
    (master_doc, 'documentation', '{{cookiecutter.package_name}} Documentation',
     [author], 1)
]
